...
let factions = {
    ...
    faction_3: {
        ...
        description: `The Red Legion\n \na religious state that has adopted the idiology of communism. All are equal under the leadership of the state which goes hand in hand with the Catholic Church.
        `,
        history: ``,
        characteristics:``,
    }
